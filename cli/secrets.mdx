...
sitectl create secrets --site-id $SITE_ID --key "DB_NAME" --value "collections"
...
sitectl create secrets \
  --site-id $SITE_ID \
  --key "DATABASE_URL" \
  --value "postgresql://user:pass@localhost:5432/collections"
```
...
# Drupal
sitectl create secrets --site-id $SITE_ID --key "DRUPAL_HASH_SALT" --value "..."

# OJS
sitectl create secrets --site-id $SITE_ID --key "OJS_SALT" --value "..."

# WordPress
sitectl create secrets --site-id $SITE_ID --key "WORDPRESS_AUTH_KEY" --value "..."
```
