...
sitectl create organization --name "Example Library"

# With description
sitectl create organization \
  --name "Example Archives" \
  --description "Public access and preservation systems"
...
sitectl create project \
  ...
  --description "Collection access sites"
```

## Best Practices

<Tip>
**Use descriptive names**: Include institution, department, or program names to make organizations easily identifiable
</Tip>
...
1. **One organization per institution or department**: Keep organizational boundaries clear
