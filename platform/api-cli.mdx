...
It's built for teams that run production open-source software — often across multiple applications — without making every project depend on a dedicated DevOps hire.

The philosophy behind `sitectl` isn't scaling servers; it's **scaling human operators**. The more institutional knowledge that lives in the tool, the fewer institutions get blocked from adopting the software they need.
